...
public class RedisCacheConfig extends CachingConfigurerSupport {
    ...
    public RedisCacheConfig(RedisConnectionFactory redisConnectionFactory, CustomCacheProperties customCacheProperties) {
...
//        stringRedisTemplate.setKeySerializer(new StringRedisSerializer());//不需要该设置,key也不会乱码.
    ...
    public CacheManager cacheManager() {
        ...
        redisCacheManager.setDefaultExpiration(customCacheProperties.getExpireTime());
        /**
...
//        Collection<String> cacheNames = redisCacheManager.getCacheNames();
        ...
        Map<String, Long> expires = customCacheProperties.generateExpireMap();
        //设置每个缓存对应的过期时间
        redisCacheManager.setExpires(expires);
        //给缓存管理器设置上缓存名s
        redisCacheManager.setCacheNames(customCacheProperties.getCacheNames());
